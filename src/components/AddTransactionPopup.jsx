          ...
          <form onSubmit={handleSubmit} className="space-y-4">
                  ...
                  {accountMembers.map((member, idx) => (
                    <div
                      ...
                      className={`flex items-center gap-3 ${
                        excludedMembers[idx] ? "opacity-40" : ""
                      }`}
                    >
                      <div className="flex items-center gap-2">
                        <input
            ...
            <div className="flex justify-end gap-4 mt-6">
              ...
              <button
                type="submit"
                disabled={loading}
                className={`px-4 py-2 bg-gradient-to-r from-blue-600 to-purple-600 text-white rounded-lg hover:from-blue-700 hover:to-purple-700 transition-all duration-200 flex items-center justify-center ${
