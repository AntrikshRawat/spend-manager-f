            ...
            <main className="mt-10 mx-auto max-w-7xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28">
              <div className="sm:text-center lg:text-left">
                <h1 className="text-4xl tracking-tight font-extrabold text-gray-900 sm:text-5xl md:text-6xl">
                  ...
                  <span className="block bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent">expenses with ease</span>
                </h1>
                <p className="mt-3 text-base text-gray-600 sm:mt-5 sm:text-lg sm:max-w-xl sm:mx-auto md:mt-5 md:text-xl lg:mx-0">
                  Track shared expenses, split bills, and manage group finances effortlessly. Perfect for roommates, friends, and family.
                </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-4">
            ...
            <div className="bg-gradient-to-br from-red-50 to-orange-50 rounded-xl p-6 text-center transform transition-all duration-300 hover:scale-105 shadow-lg">
              <div className="text-4xl font-bold bg-gradient-to-r from-red-600 to-orange-600 bg-clip-text text-transparent mb-2">4.9/5</div>
            ...
            <div className="space-y-10 md:space-y-0 md:grid md:grid-cols-2 md:gap-x-8 md:gap-y-10">
              ...
              <div className="relative group">
                ...
                <div className="relative p-6 bg-white/80 backdrop-blur-sm rounded-lg shadow-lg">
                  ...
                  <h3 className="text-lg leading-6 font-medium text-gray-900">Group Accounts</h3>
                  <p className="mt-2 text-base text-gray-600">
                    Create shared accounts with up to 6 members. Perfect for roommates, friends, or family members.
                  </p>
                </div>
              </div>
              ...
              <div className="relative group">
                ...
                <div className="relative p-6 bg-white/80 backdrop-blur-sm rounded-lg shadow-lg">
                  ...
                  <p className="mt-2 text-base text-gray-600">
                    Get instant notifications when members add new payments to your shared accounts.
                  </p>
                </div>
              </div>
              ...
              <div className="relative group">
                ...
                <div className="relative p-6 bg-white/80 backdrop-blur-sm rounded-lg shadow-lg">
                  ...
                  <p className="mt-2 text-base text-gray-600">
                    Track individual and group spending. See who spent what and monitor total expenses.
                  </p>
                </div>
              </div>
              ...
              <div className="relative group">
                ...
                <div className="relative p-6 bg-white/80 backdrop-blur-sm rounded-lg shadow-lg">
                  ...
                  <p className="mt-2 text-base text-gray-600">
                    View detailed transaction history in a clean, organized table format.Now tracking transaction is easiar.
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="mt-12">
            <div className="grid grid-cols-1 gap-8 md:grid-cols-3">
              <div className="relative">
                ...
                <p className="mt-2 text-base text-gray-600">
                  Sign up and create your profile. It takes less than a minute to get started.
                </p>
              </div>
              ...
              <div className="relative">
                ...
                <h3 className="mt-4 text-lg font-medium text-gray-900">Add Group Members</h3>
                <p className="mt-2 text-base text-gray-600">
              ...
              <div className="relative">
                ...
                <h3 className="mt-4 text-lg font-medium text-gray-900">Start Tracking</h3>
                <p className="mt-2 text-base text-gray-600">
      ...
      <div className="bg-gradient-to-r from-blue-600 to-purple-600">
        <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:py-16 lg:px-8 lg:flex lg:items-center lg:justify-between">
          <h2 className="text-3xl font-extrabold tracking-tight text-white sm:text-4xl">
            <span className="block">Ready to start managing your expenses?</span>
